...
(function($) {
    ...
    Colorpicker.prototype = {
        ...
        update: function() {
            var color = null;//this.isInput ? this.element.prop('value') : this.element.data('color');
        ...
        hide: function() {
            ...
            this.component.attr("data-color", value);
        ...
        mousemove: function(e) {
            ...
            this.component.attr("data-color", this.color.toHex());
